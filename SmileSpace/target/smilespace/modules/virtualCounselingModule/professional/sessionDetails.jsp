...
<div class="container">
    ...
    <div class="card">
        <h2>
            Session Information
            <span class="status-badge status-<%= sessionObj.getStatus().toLowerCase() %>">
                <%= sessionObj.getStatus() %>
            </span>
        </h2>
        ...
        <div class="detail-row">
            ...
            <div class="detail-value"><%= sessionObj.getFormattedDateTime() %></div>
        </div>
    ...
    <div class="card">
        ...
        <div class="detail-row">
            ...
            <div class="detail-value risk-<%= student.getRiskLevel().toLowerCase() %>">
    ...
    <% if (sessionObj.isCompleted() && sessionObj.getSummary() != null) { %>
    <div class="card">
        ...
        <div class="detail-row">
            <div class="detail-label">Observed Mood</div>
        ...
        <div class="detail-row">
            ...
            <div class="detail-value"><%= sessionObj.getDocumentedDateFormatted() %></div>
        </div>
    </div>
    <% } %>

    <div class="actions">
        <% if (!sessionObj.isCompleted() && !sessionObj.isCancelled()) { %>
