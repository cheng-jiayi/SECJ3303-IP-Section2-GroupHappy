...
<head>
    ...
    <style>
        ...
        @media (min-width: 1200px) {
            /* Wide screens: Summary and Insights on left, Calendar on right */
            .monthly-main-content {
                display: grid;
                grid-template-columns: 1fr 2fr;
                gap: 30px;
        ...
        @media (max-width: 1199px) {
            /* Smaller screens: Summary, Calendar, Insights (vertical order) - Full width */
            .monthly-main-content {
                display: flex;
                flex-direction: column;
                gap: 30px;
            ...
            .monthly-left-panel {
                display: contents; /* This removes the flex container and lets items flow naturally */
            }
            
            /* Make summary and calendar use full width */
            .month-summary {
                order: 1;
                width: 100%;
            ...
            <div class="day-column" 
                ...
                <div class="mood-icons-container">
                    ...
                    <%
                            ...
                            // No mood entry - show empty circle
                    %>
            ...
            <div class="month-grid">
                ...
                %>
                        <div class="calendar-day" 
                             data-date="<%= dateKey %>" 
                             data-formatted-date="<%= calendarDate.format(displayDateFormat) %>" 
                             data-has-mood="<%= hasMoodData %>"
                             onclick="showDateMood(this)">
                            ...
                            <div class="day-moods">
                                ...
                                <%
                                        ...
                                        // Show indicator if there are more than 3 moods
                                        if (feelings.size() > 3) {
                                %>
...
<script>
    function showDateMood(element) {
        ...
        if (hasMoodData) {
            // If there's mood data, show prompt about viewing entry details
            modalMessage.textContent = "You have recorded your mood for this day. You can view the entry details.";
            modalActions.innerHTML = `
                <button onclick="viewDailyDetails('${date}')" class="modal-details-btn">
                    View Entry Details
                </button>
            `;
        } else {
            // If no mood data, show prompt about no entry
            modalMessage.textContent = "You didn't record your mood for this day.";
            modalActions.innerHTML = `
                <button onclick="addNewMood()" class="modal-details-btn">
                    Add Mood Entry
                </button>
            `;
        }
    ...
    function viewDailyDetails(date) {
        // Redirect to daily mood view page with the selected date
        window.location.href = 'mood?action=viewDaily&date=' + date;
    }

    function addNewMood() {
        // Redirect to add mood page
        window.location.href = 'mood?action=add';
    }
    ...
    function changePeriod(period) {
        // Reload the page with the selected period
        window.location.href = 'mood?action=viewTrends&period=' + period;
    }
