...
<%
    ...
    StringBuilder backUrl = new StringBuilder("mood?action=add");
...
<div class="container">
    ...
    <!-- Submit to your MoodServlet -->
    <form action="mood" method="post">
        <!-- Pass selected feelings as hidden fields -->
        <% for(String feeling : selectedFeelings) { %>
            <input type="hidden" name="feelings" value="<%= feeling %>">
        <% } %>
        
        <!-- Pass action and ID for editing -->
