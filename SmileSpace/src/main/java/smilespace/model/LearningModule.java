...
public class LearningModule {
    ...
    public void setResourceFile(String resourceFile) { 
        this.resourceFilePath = resourceFile; 
    }
    ...
    public void setLearningGuide(String learningGuide) { 
    ...
    public String toString() {
        return "LearningModule{id='" + id + "', title='" + title + "', category='" + category + "', status='" + status + "'}";
    }
}