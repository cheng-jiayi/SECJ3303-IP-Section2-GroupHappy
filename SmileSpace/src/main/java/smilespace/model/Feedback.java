...
public class Feedback {
    ...
    private boolean hasUnseenReply;
    private String userReply;
    private Date userReplyDate;
    ...
    public void setRating(Integer rating) { this.rating = rating; }
        ...
        public boolean isHasUnseenReply() { return hasUnseenReply; }
    public void setHasUnseenReply(boolean hasUnseenReply) { this.hasUnseenReply = hasUnseenReply; }
    
    public String getUserReply() { return userReply; }
    public void setUserReply(String userReply) { this.userReply = userReply; }
    
    public Date getUserReplyDate() { return userReplyDate; }
    public void setUserReplyDate(Date userReplyDate) { this.userReplyDate = userReplyDate; }
