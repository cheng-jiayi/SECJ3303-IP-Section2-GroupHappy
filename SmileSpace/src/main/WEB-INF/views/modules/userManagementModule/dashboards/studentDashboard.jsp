...
<body>
    ...
    <div class="container">
        ...
        <div class="card-container">
            ...
            <div class="card" onclick="window.location.href='<%= request.getContextPath() %>/self-assessment'">
                <div class="card-icon">
        ...
        <div class="chatbox" id="chatbox">
            ...
            <div class="chatbox-body">
                <div class="chat-options">
                    ...
                    <a href="<%= request.getContextPath() %>/ai/learn" class="chat-option">
                    ...
                    <a href="<%= request.getContextPath() %>/ai/chat" class="chat-option">
                        <div class="chat-option-icon">
                            <i class="fas fa-comments"></i>
                        </div>
                        <div class="chat-option-content">
