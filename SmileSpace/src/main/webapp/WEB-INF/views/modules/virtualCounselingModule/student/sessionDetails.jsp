...
<div class="container">
    ...
    <div class="card">
        ...
        <!-- Use getSessionSummary() instead of getSummary() -->
        ...
        <!-- Use getProgressNotes() for progress notes -->
        ...
        <!-- Check if nextSessionSuggested is not null (it's a LocalDateTime, not String) -->
        <% if (sessionObj.getNextSessionSuggested() != null) { %>
        <div class="detail-row">
