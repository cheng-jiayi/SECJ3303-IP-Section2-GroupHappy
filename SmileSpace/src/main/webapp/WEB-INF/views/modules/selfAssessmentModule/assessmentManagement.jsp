...
<head>
    ...
    <style>
        ...
        .select-mode .assessment-checkbox {
            display: inline-block;
        }
        
        .selected-row {
            background-color: #FFF3C8 !important;
            border-left: 4px solid #F0A548 !important;
        }
...
<body>
    <div class="top-nav">
        ...
        <div class="nav-actions">
            ...
            <button id="selectModeBtn" class="filter-btn" style="background: #6B4F36;">
    ...
    <div class="batch-actions" id="batchActions">
        ...
        <div class="batch-buttons">
            <button id="batchDeleteBtn" class="btn-batch-delete">
                <i class="fas fa-trash"></i> Delete Selected
            </button>
            <button id="batchCancelBtn" class="btn-batch-cancel">
    ...
    <div class="assessments-container">
        <div class="assessments-table-container">
            <form id="batchDeleteForm" action="${pageContext.request.contextPath}/self-assessment/delete-batch" method="post">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach var="assessment" items="${assessments}">
                                    <tr id="assessment-${assessment.assessmentId}" class="assessment-row">
                                        <td>
                                            <input type="checkbox" name="assessmentIds" 
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                ...
                                                <form action="${pageContext.request.contextPath}/self-assessment/delete" 
                                                    ...
                                                    <button type="submit" class="btn-action btn-delete" onclick="return confirmDelete('${assessment.assessmentId}')">
    ...
    <script>
        ...
        document.getElementById('selectModeBtn').addEventListener('click', function() {
            ...
            if (isSelectMode) {
                ...
                document.getElementById('selectModeBtn').innerHTML = '<i class="fas fa-times"></i> Cancel Selection';
                document.getElementById('selectModeBtn').style.background = '#E74C3C';
                
                document.querySelectorAll('.assessment-checkbox').forEach(checkbox => {
                    checkbox.style.display = 'inline-block';
                });
                
                document.querySelectorAll('.action-buttons').forEach(buttonGroup => {
        ...
        document.addEventListener('click', function(e) {
            if (isSelectMode && e.target.closest('.assessment-row')) {
                const row = e.target.closest('.assessment-row');
                const checkbox = row.querySelector('.assessment-checkbox');
                
                if (checkbox && !e.target.classList.contains('assessment-checkbox')) {
        ...
        document.getElementById('batchDeleteBtn').addEventListener('click', function() {
            const selectedCount = selectedAssessments.size;
            ...
            if (confirm('Are you sure you want to delete ' + selectedCount + ' assessment(s)? This action cannot be undone.')) {
        ...
        function exitSelectMode() {
            ...
            document.getElementById('selectModeBtn').innerHTML = '<i class="fas fa-check-square"></i> Select Multiple';
            document.getElementById('selectModeBtn').style.background = '#6B4F36';
        ...
        function updateRowSelection(checkbox) {
            const row = checkbox.closest('.assessment-row');
        ...
        function updateSelectedCount() {
            ...
            if (selectedCount > 0) {
                batchDeleteBtn.innerHTML = '<i class="fas fa-trash"></i> Delete ' + selectedCount + ' Selected';
            } else {
