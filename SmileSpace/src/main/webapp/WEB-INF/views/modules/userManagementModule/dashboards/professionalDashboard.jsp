...
<body>
    ...
    <div class="container">
        ...
        <div class="card-container">
            <div class="card" onclick="window.location.href='<%= request.getContextPath() %>/admin-module-dashboard'">
                <div class="card-icon">
            ...
            <div class="card" onclick="window.location.href='<%= request.getContextPath() %>/self-assessment/manage'">
                <div class="card-icon">
