...
<body>
    ...
    <div class="quiz-container">
        ...
        <div class="action-buttons">
            <a href="student-module?id=<%= moduleId %>&category=<%= encodedCategory %>" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i>
                Go Back
            </a>
            <a href="quiz?action=take&moduleId=<%= moduleId %>&category=<%= encodedCategory %>" class="btn btn-primary">
