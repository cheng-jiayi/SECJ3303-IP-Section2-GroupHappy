...
<%
    ...
    if (questions == null || questions.isEmpty()) {
        response.sendRedirect("quiz?action=start&moduleId=" + moduleId + "&category=" + encodedCategory);
        return;
    }
%>
<!DOCTYPE html>
        ...
        <form id="quizForm" action="quiz" method="post">
            ...
            <div class="quiz-card">
                ...
                <div class="action-buttons">
                    <a href="quiz?action=start&moduleId=<%= moduleId %>&category=<%= encodedCategory %>" class="btn btn-secondary">Cancel</a>
