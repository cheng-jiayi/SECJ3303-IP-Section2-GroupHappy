        ...
        <div class="questions-review">
            ...
            <%
                ...
                for (Question question : result.getQuestions()) {
                    ...
                    try {
                        java.lang.reflect.Method getCorrectAnswerMethod = question.getClass().getMethod("getCorrectAnswer");
                        correctAnswer = (Boolean) getCorrectAnswerMethod.invoke(question);
                    } catch (Exception e1) {
                        try {
                            java.lang.reflect.Method isTrueMethod = question.getClass().getMethod("isTrue");
                            correctAnswer = (Boolean) isTrueMethod.invoke(question);
                        } catch (Exception e2) {
                            correctAnswer = true;
                        }
                    }
            ...
            <div class="question-item <%= isCorrect ? "correct" : "incorrect" %>">
                ...
                <div class="answer-info">
                    <div class="correct-answer">
                        ...
                        <span>Correct Answer: <strong><%= correctAnswer ? "True" : "False" %></strong></span>
                    </div>
                    <% if (userAnswer != null) { %>
