                    ...
                    <c:forEach var="feedback" items="${feedbackList}">
                        <div class="feedback-card" id="feedback-${feedback.id}">
                            ...
                            <c:if test="${not empty feedback.userReply}">
                                <div class="feedback-reply" style="background: #F0FFE8; border-left: 4px solid #2ECC71;">
                                    <div class="reply-header">
                                        <strong><i class="fas fa-user"></i> User Follow-up Reply</strong>
                                        <c:if test="${not empty feedback.userReplyDate}">
                                            <span class="reply-date">
                                                Replied: <fmt:formatDate value="${feedback.userReplyDate}" pattern="dd MMM yyyy, HH:mm" />
                                            </span>
                                        </c:if>
                                    </div>
