...
<head>
    <meta charset="UTF-8">
    <title>Professional Sessions - SmileSpace</title>
...
<div class="container">
    <div class="header">
        <div>
            ...
            <div class="subtitle">Manage all student counseling sessions and document progress.</div>
        </div>
    </div>
    ...
    <div class="sessions-table">
        <% if (sessions == null || sessions.isEmpty()) { %>
            <div class="empty-state">
                ...
                <p>There are no counseling sessions scheduled at the moment.</p>
            </div>
        <% } else { %>
            <table>
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <a href="counseling?action=documentSession&sessionId=<%= counselingSession.getSessionId() %>" 
