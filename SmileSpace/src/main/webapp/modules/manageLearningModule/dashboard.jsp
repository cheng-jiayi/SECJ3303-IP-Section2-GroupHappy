        ...
        <div class="content">
            ...
            <div class="header-row">
                ...
                <div class="search-container">
                    ...
                    <form action="dashboard" method="GET" style="display: inline-block; width: 100%;">
            ...
            <div class="filters">
                <form action="dashboard" method="GET" id="filterForm">
                    ...
                    <div style="text-align: center;">
                        ...
                        <button type="button" class="filter-btn" style="background: #F0D5B8; color: #713C0B; margin-left: 10px;" onclick="window.location.href='dashboard'">
