...
<%
    ...
    if (backUrl == null || backUrl.isEmpty()) {
        ...
        if (moodToEdit != null) {
            backUrl = "mood?action=viewDaily&date=" + moodToEdit.getEntryDate();
        } 
        // Fallback based on referrer parameter
        else if ("trends".equals(referrer)) {
            backUrl = "mood?action=viewTrends";
        } else {
            backUrl = "mood"; // default to recordMood
        }
    }
%>
<!DOCTYPE html>
...
<div class="container">
    ...
    <!-- Submit to servlet -->
    <form id="feelingsForm" action="mood" method="post">
