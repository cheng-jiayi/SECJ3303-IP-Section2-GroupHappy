...
<%
    ...
    if (percentage >= 80) {
        ...
        resultMessage = "Excellent! You have a strong understanding of stress management techniques.";
        resultIcon = "🏆";
    } else if (percentage >= 60) {
        resultCategory = "good";
        resultMessage = "Good job! You understand the basics of stress management.";
        resultIcon = "👍";
    } else {
...
<body>
    <div class="result-container">
        <div class="header">
            ...
            <div class="module-badge">UC006 - Stress Module</div>
        ...
        <div class="questions-review">
            ...
            <div class="question-item <%= isCorrect ? "correct" : "incorrect" %>">
                <div class="question-text">
                    <strong>Q<%= question.getId() %>.</strong> <%= question.getText() %>
                </div>
        ...
        <div class="action-buttons">
            <a href="quiz-dashboard" class="btn btn-secondary">
                <i class="fas fa-th-large"></i>
                Back to Dashboard
            </a>
            <a href="student-module?id=UC006" class="btn btn-primary">
