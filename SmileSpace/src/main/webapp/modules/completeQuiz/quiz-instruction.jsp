...
<body>
    <div class="quiz-container">
        ...
        <div class="tip-box">
            ...
            <p>Take your time to recall what you've learned about recognizing stress, relaxation techniques, and healthy coping habits. Review the module content if needed before starting.</p>
        </div>
        
        <div class="action-buttons">
            <a href="student-module?id=UC006" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i>
                Go Back
            </a>
            <a href="quiz?action=take" class="btn btn-primary">
