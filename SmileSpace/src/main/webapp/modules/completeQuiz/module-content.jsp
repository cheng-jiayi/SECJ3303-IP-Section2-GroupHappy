...
<body>
    ...
    <div class="container">
        ...
        <div class="video-container">
            ...
            <div class="video-wrapper">
                <% if (videoUrl != null) { %>
                    <!-- Replace the entire iframe section with: -->
                    <iframe src="https://www.youtube.com/embed/zYzFUBMJO9E" 
        ...
        <div class="action-section">
            ...
            <a href="quiz?action=start" class="btn-finish">
    ...
    <script>
        ...
        // Simulate video progress (in real app, this would track actual video playback)
        let progress = 0;
        const progressInterval = setInterval(() => {
            if (progress < 100) {
                ...
                // Enable finish button when progress reaches 95%
                if (progress >= 95) {
        ...
        // If there's no video, enable button immediately
