...
<body>
    ...
    <div class="container">
        <form id="quizForm" action="quiz" method="post">
            <!-- Hidden input to store total questions count -->
            <input type="hidden" id="totalQuestionsHidden" value="<%= totalQuestionsCount %>">
            
            <div class="quiz-header">
                <h1 class="quiz-title">Managing Stress in Daily Life</h1>
            ...
            <div class="quiz-card">
                ...
                <div class="action-buttons">
                    <a href="quiz?action=start" class="btn btn-secondary">Cancel</a>
