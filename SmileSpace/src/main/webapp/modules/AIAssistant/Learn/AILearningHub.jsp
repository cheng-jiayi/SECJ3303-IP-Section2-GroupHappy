...
<div class="container">
    ...
    <div class="card-container">
        ...
        <div class="card" onclick="window.location.href='<%= request.getContextPath() %>/modules/AIAssistant/Learn/learn-module.jsp?module=stress&topic=1'">
    ...
    <div class="ai-modal">
        ...
        <div class="modal-body">
            ...
            <div class="ai-greeting">
                Hi there! Ready to choose a topic to learn today? I'm here to help you learn and grow.
            </div>
...
<script>
    ...
    function startLearning() {
        window.location.href = 'learn-module.jsp?module=stress&topic=1';
    }
