...
<%
    ...
    // If no user name in session, use default
    String userFullName = "Student";
...
<body>
    ...
    <div class="header">
        ...
        <div class="nav-buttons">
            <a href="AILearningHub.jsp" class="nav-btn secondary">
                <i class="fas fa-home"></i> Learning Hub
            </a>
            <a href="../../userManagementModule/dashboards/studentDashboard.jsp" class="nav-btn">
        ...
        <% if (!isComplete) { %>
            ...
            <div class="learning-header">
                ...
                <div class="topic-indicator">
                    <span>Topic <%= currentTopic %> of 3 : <%= topicTitles[currentTopic-1] %></span>
                ...
                <div class="topic-nav-dots">
                    <% for (int i = 1; i <= 3; i++) { %>
                        <div class="topic-dot <%= (i == currentTopic) ? "active" : "" %>" 
                            onclick="location.href='learn-module.jsp?module=<%= module %>&topic=<%= i %>'"></div>
                    <% } %>
                </div>
            </div>
            ...
            <div class="chat-section">
                ...
                <div class="ai-message-box">
                    ...
                    <div class="ai-message">
                        Hi <%= userFullName %>! <%= aiMessages[currentTopic-1] %> What would you like to know about <%= topicTitles[currentTopic-1].toLowerCase() %>?
                        <br><br>
                        <strong>Try asking:</strong>
                        <ul style="margin-top: 10px; padding-left: 20px;">
                            <li>"What is <%= topicTitles[currentTopic-1].toLowerCase() %>?"</li>
                ...
                <div class="content-section">
                    <div class="content-box">
                        ...
                        <div class="example-box">
                            ...
                            <div class="content-text">
                                <%= exampleContents[currentTopic-1] %>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="chat-input-area">
                    <div class="input-wrapper">
                        <input type="text" 
                               class="chat-input" 
                               id="messageInput"
                               placeholder="Ask about <%= topicTitles[currentTopic-1].toLowerCase() %>..."
    ...
    <script>
        ...
        function nextTopic() {
            if (currentTopic < 3) {
                window.location.href = 'learn-module.jsp?module=<%= module %>&topic=' + (currentTopic + 1);
            }
        }

        function completeModule() {
            window.location.href = 'learn-module.jsp?module=<%= module %>&topic=complete';
        }
